...
tags: []
---
<p>It's survey time again so start figuring out your favourite albums and tracks and then head on over to the survey form and make your pics. You can choose one album and five tracks for each artist (Galaxie 500, Luna, Damon & Naomi and Dean & Britta). I'll probably let it run for three or four weeks (or when the form-filling dries up) so expect results shortly before xmas.</p>
