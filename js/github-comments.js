...
function DoGithubComments(repo_name, comment_id)
{
    document.addEventListener("DOMContentLoaded", async function() 
    {
        try {
            ...
            commentsElement.innerHTML = "<form action='" + url + "' rel='nofollow'> <input class='btn btn-secondary mb-2' type='submit' value='Post a comment' /><br><small><em>(free github account required)</em></small></form>" + commentsHtml;
        } catch (err)
        {
