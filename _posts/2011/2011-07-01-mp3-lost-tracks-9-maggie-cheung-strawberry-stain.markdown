...
For the 2004 film <a href="http://en.wikipedia.org/wiki/Clean_%282004_film%29">Clean</a>, Dean Wareham teamed up with lead actor <a href="http://en.wikipedia.org/wiki/Maggie_Cheung">Maggie Cheung</a> to record a couple of songs for the <span class="removed_link" title="https://db.fullofwishes.co.uk/wiki/Clean">soundtrack</span>. </p>
